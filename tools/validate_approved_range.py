...
def main():
    ...
    historical_default = {**cases['default'], 'visibleEntities':[e for e in cases['default']['visibleEntities'] if e['id'] not in {'faucet-approved','approved-stone-02','approved-stone-03'}]}
