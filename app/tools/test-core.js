...
assert.equal(visibility.getVisibleEntities(scene,initial).length,16);
...
assert.equal(r["sink-approved"].reason,"host-hidden");
assert.equal(r["drainer-approved"].reason,"host-hidden");
assert.equal(r["cooktop-approved"].visible,true);
...
assert.equal(r["cooktop-approved"].reason,"host-hidden");
assert.equal(r["sink-approved"].visible,true);
assert.equal(r["stone-02-joint-bridge"].reason,"host-hidden");
assert.equal(r["stone-03-joint-bridge"].reason,"host-hidden");
